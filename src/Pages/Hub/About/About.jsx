            ...
            <div className='max-w-6xl mx-auto space-y-16'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 items-start reveal-item visible'>
                    <div className='space-y-6'>
                        <Description
                         text={"We treat classical Sanatan texts as knowledge systems—taught with academic respect and public accountability."}
                         style="text-slate-700 text-xl font-serif-elegant italic"
                        />
                        <div className='bg-[#FDFCF8] border border-slate-100 rounded-4xl p-6'>
                            <p className='text-[10px] uppercase tracking-[0.4em] text-orange-500 font-black mb-3'>Recent outcomes</p>
                            <ul className='space-y-2 text-sm text-slate-600'>
                                <li>2024: Digital safety toolkit shipped to 1,200+ families.</li>
                                <li>2025: 3 volunteer hubs activated with verified onboarding.</li>
                                <li>2025: Curriculum framework released for public review.</li>
                            </ul>
                        </div>
